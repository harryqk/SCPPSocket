...
namespace scppsocket
{
    ...
    void TCPClientNetManagerWorkerLinux::DoWork()
    {
        int nread;
...
//                    delete[] msg;
    ...
    void TCPClientNetManagerWorkerLinux::SendMessage(const char *Msg, int Len)
    {
...
//        }
    ...
    void TCPClientNetManagerWorkerLinux::HandleRead()
    {

    }

    int TCPClientNetManagerWorkerLinux::HandleConnect()
    {
        int client_fd;
        int result;
    ...
    void TCPClientNetManagerWorkerLinux::StopWork()
    {
