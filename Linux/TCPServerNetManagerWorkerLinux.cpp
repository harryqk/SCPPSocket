...
{
    void TCPServerNetManagerWorkerLinux::DoWork()
    {
        int server_sockfd;
        int result;
    ...
    void TCPServerNetManagerWorkerLinux::HandleAccept()
    {
        int client_sockfd;
    ...
    void TCPServerNetManagerWorkerLinux::HandleRead()
    {
        int nread;
...
//                    delete[] msg;
    ...
    void TCPServerNetManagerWorkerLinux::Broadcast(const char *Msg, int Len)
    {
        std::list<Connection*>::iterator p1;
        for(p1=ConnectionsToClient.begin();p1!=ConnectionsToClient.end();p1++)
        {
    ...
    void TCPServerNetManagerWorkerLinux::StopWork()
    {
        delete[] LenBuf;
        LenBuf = nullptr;
        delete[] ReadBuf;
