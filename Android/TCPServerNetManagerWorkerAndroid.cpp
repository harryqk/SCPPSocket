...
{
    void TCPServerNetManagerWorkerAndroid::DoWork()
    {
        int server_sockfd;
        int result;
    ...
    void TCPServerNetManagerWorkerAndroid::HandleAccept()
    {
        int client_sockfd;
    ...
    void TCPServerNetManagerWorkerAndroid::HandleRead()
    {
        int nread;
...
//                    delete[] msg;
    ...
    void TCPServerNetManagerWorkerAndroid::Broadcast(const char *Msg, int Len)
    {
        std::list<Connection*>::iterator p1;
        for(p1=ConnectionsToClient.begin();p1!=ConnectionsToClient.end();p1++)
        {
    ...
    void TCPServerNetManagerWorkerAndroid::StopWork()
    {
        delete[] LenBuf;
        LenBuf = nullptr;
        delete[] ReadBuf;
